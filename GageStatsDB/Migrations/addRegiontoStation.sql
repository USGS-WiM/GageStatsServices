...
VALUES ('20181025200232_init', '3.1.7');
...
INSERT INTO gagestats."_EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20190522162439_reconfigureObjects', '3.1.7');

ALTER TABLE gagestats."Statistics" ADD "IsPreferred" boolean NOT NULL DEFAULT FALSE;

INSERT INTO gagestats."_EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20200423200043_StatisticIsPreferred', '3.1.7');
...
ALTER TABLE gagestats."Stations" ADD "RegionID" integer;
...
INSERT INTO gagestats."_EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20200904213250_addRegiontoStation', '3.1.7');
