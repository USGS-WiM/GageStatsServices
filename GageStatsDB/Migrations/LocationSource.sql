...
VALUES ('20181025200232_init', '3.1.4');
...
INSERT INTO gagestats."_EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20190522162439_reconfigureObjects', '3.1.4');

ALTER TABLE gagestats."Statistics" ADD "IsPreferred" boolean NOT NULL DEFAULT FALSE;

INSERT INTO gagestats."_EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20200423200043_StatisticIsPreferred', '3.1.4');

DROP TABLE gagestats."User";

ALTER TABLE gagestats."Statistics" ALTER COLUMN "ID" TYPE integer;
ALTER TABLE gagestats."Statistics" ALTER COLUMN "ID" SET NOT NULL;
ALTER SEQUENCE gagestats."Statistics_ID_seq" RENAME TO "Statistics_ID_old_seq";
ALTER TABLE gagestats."Statistics" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE gagestats."Statistics" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY;
SELECT * FROM setval('gagestats."Statistics_ID_seq"', nextval('gagestats."Statistics_ID_old_seq"'), false);
DROP SEQUENCE gagestats."Statistics_ID_old_seq";

ALTER TABLE gagestats."StatisticError" ALTER COLUMN "ID" TYPE integer;
ALTER TABLE gagestats."StatisticError" ALTER COLUMN "ID" SET NOT NULL;
ALTER SEQUENCE gagestats."StatisticError_ID_seq" RENAME TO "StatisticError_ID_old_seq";
ALTER TABLE gagestats."StatisticError" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE gagestats."StatisticError" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY;
SELECT * FROM setval('gagestats."StatisticError_ID_seq"', nextval('gagestats."StatisticError_ID_old_seq"'), false);
DROP SEQUENCE gagestats."StatisticError_ID_old_seq";

ALTER TABLE gagestats."StationTypes" ALTER COLUMN "ID" TYPE integer;
ALTER TABLE gagestats."StationTypes" ALTER COLUMN "ID" SET NOT NULL;
ALTER SEQUENCE gagestats."StationTypes_ID_seq" RENAME TO "StationTypes_ID_old_seq";
ALTER TABLE gagestats."StationTypes" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE gagestats."StationTypes" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY;
SELECT * FROM setval('gagestats."StationTypes_ID_seq"', nextval('gagestats."StationTypes_ID_old_seq"'), false);
DROP SEQUENCE gagestats."StationTypes_ID_old_seq";

ALTER TABLE gagestats."Stations" ALTER COLUMN "ID" TYPE integer;
ALTER TABLE gagestats."Stations" ALTER COLUMN "ID" SET NOT NULL;
ALTER SEQUENCE gagestats."Stations_ID_seq" RENAME TO "Stations_ID_old_seq";
ALTER TABLE gagestats."Stations" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE gagestats."Stations" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY;
SELECT * FROM setval('gagestats."Stations_ID_seq"', nextval('gagestats."Stations_ID_old_seq"'), false);
DROP SEQUENCE gagestats."Stations_ID_old_seq";

ALTER TABLE gagestats."Stations" ADD "RegionID" integer NULL;

ALTER TABLE gagestats."PredictionInterval" ALTER COLUMN "ID" TYPE integer;
ALTER TABLE gagestats."PredictionInterval" ALTER COLUMN "ID" SET NOT NULL;
ALTER SEQUENCE gagestats."PredictionInterval_ID_seq" RENAME TO "PredictionInterval_ID_old_seq";
ALTER TABLE gagestats."PredictionInterval" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE gagestats."PredictionInterval" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY;
SELECT * FROM setval('gagestats."PredictionInterval_ID_seq"', nextval('gagestats."PredictionInterval_ID_old_seq"'), false);
DROP SEQUENCE gagestats."PredictionInterval_ID_old_seq";

ALTER TABLE gagestats."Citations" ALTER COLUMN "ID" TYPE integer;
ALTER TABLE gagestats."Citations" ALTER COLUMN "ID" SET NOT NULL;
ALTER SEQUENCE gagestats."Citations_ID_seq" RENAME TO "Citations_ID_old_seq";
ALTER TABLE gagestats."Citations" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE gagestats."Citations" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY;
SELECT * FROM setval('gagestats."Citations_ID_seq"', nextval('gagestats."Citations_ID_old_seq"'), false);
DROP SEQUENCE gagestats."Citations_ID_old_seq";

ALTER TABLE gagestats."Characteristics" ALTER COLUMN "ID" TYPE integer;
ALTER TABLE gagestats."Characteristics" ALTER COLUMN "ID" SET NOT NULL;
ALTER SEQUENCE gagestats."Characteristics_ID_seq" RENAME TO "Characteristics_ID_old_seq";
ALTER TABLE gagestats."Characteristics" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE gagestats."Characteristics" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY;
SELECT * FROM setval('gagestats."Characteristics_ID_seq"', nextval('gagestats."Characteristics_ID_old_seq"'), false);
DROP SEQUENCE gagestats."Characteristics_ID_old_seq";

ALTER TABLE gagestats."Agencies" ALTER COLUMN "ID" TYPE integer;
ALTER TABLE gagestats."Agencies" ALTER COLUMN "ID" SET NOT NULL;
ALTER SEQUENCE gagestats."Agencies_ID_seq" RENAME TO "Agencies_ID_old_seq";
ALTER TABLE gagestats."Agencies" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE gagestats."Agencies" ALTER COLUMN "ID" ADD GENERATED BY DEFAULT AS IDENTITY;
SELECT * FROM setval('gagestats."Agencies_ID_seq"', nextval('gagestats."Agencies_ID_old_seq"'), false);
DROP SEQUENCE gagestats."Agencies_ID_old_seq";

INSERT INTO gagestats."_EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20200904213250_addRegiontoStation', '3.1.4');

ALTER TABLE gagestats."Stations" ALTER COLUMN "RegionID" TYPE integer;
ALTER TABLE gagestats."Stations" ALTER COLUMN "RegionID" DROP NOT NULL;
ALTER TABLE gagestats."Stations" ALTER COLUMN "RegionID" DROP DEFAULT;

ALTER TABLE gagestats."Stations" ADD "LocationSource" text NULL;

INSERT INTO gagestats."_EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20201027153515_LocationSource', '3.1.4');
