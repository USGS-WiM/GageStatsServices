...
namespace GageStatsServices.Test
{
    public class GageStatsTest
    {
        public GageStatsController controller { get; private set; }
        public GageStatsTest() {
            //Arrange
            controller = new GageStatsController(new InMemoryGageStatsAgent());
    ...
    public class InMemoryGageStatsAgent : IGageStatsAgent
    {

        public List<Message> Messages => throw new NotImplementedException();

        public InMemoryGageStatsAgent()
        {
